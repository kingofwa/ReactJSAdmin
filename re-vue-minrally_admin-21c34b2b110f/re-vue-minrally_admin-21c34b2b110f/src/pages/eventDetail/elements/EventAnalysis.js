...
const EventAnalysis = () => {
  ...
  const renderAnalysisAll = () => {
    return (
      <div className="event-detail-row">
        <Col span={14}>
          <SummaryTable data={summaryData} loading={loading} />
          <MonthTable data={monthlyData} loading={loading} isAnalysisAll />
        </Col>
  ...
  const renderAnalysisDaily = () => {
    return (
      <div className="event-detail-row">
        <Col span={14}>
          <SummaryTable loading={loading} data={summaryData} isDaily />
          <PrefectureTable loading={loading} data={prefectureData} />
        </Col>
        <Col className="prefecture-col">
          <DailyTable loading={loading} data={dailyData} />
        </Col>
      </div>
    );
  };
